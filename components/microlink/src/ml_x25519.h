...
#ifndef __ML_X25519_H__
#define __ML_X25519_H__

#define X25519_BYTES (256/8)

/* The base point (9) */
extern const unsigned char ML_X25519_BASE_POINT[X25519_BYTES];
...
/* ml_x25519 scalar multiplication.  Sets out to scalar*base.
 *
 ...
 * This adds almost no security, but permits interop with other ml_x25519
 ...
 */
static inline int ml_x25519_base (
    unsigned char out[EC_PUBLIC_BYTES],
    const unsigned char scalar[EC_PRIVATE_BYTES],
    int clamp
) {
    return ml_x25519(out,scalar,ML_X25519_BASE_POINT,clamp);
}

/**
 * As ml_x25519_base, but with a scalar that's EC_UNIFORM_BYTES long,
 ...
 */
static inline void ml_x25519_base_uniform (
    unsigned char out[EC_PUBLIC_BYTES],
    const unsigned char scalar[EC_UNIFORM_BYTES]
) {
    (void)ml_x25519_base(out,scalar,0);
}

/**
 * STROBE-compatible Schnorr signatures using curve25519 (not ed25519)
 *
 * The user will call ml_x25519_base_uniform(eph,eph_secret) to schedule
 ...
 * This function is the public equivalent ml_x25519_sign_p2, taking the long-term
